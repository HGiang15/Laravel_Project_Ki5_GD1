    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link fs-5" href="{{ route('books.index') }}"> <i class="fa-solid fa-book text-success mx-1"></i>Books</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fs-5" href="{{ route('reviews.index') }}"><i class="fa-solid fa-chart-area text-secondary mx-1"></i>Review</a>
                </li>
            </ul>
