        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class=""><a href="dashboard_2.html">QL sản phẩm</a></li>
                    <li><a href="dashboard_3.html">QL ...</a></li>
                    <li><a href="dashboard_4_1.html">QL ...</a></li>
                    <li><a href="dashboard_5.html">QL ... </a></li>
                </ul>
            </li>
            {{-- Layouts --}}
            <li>
