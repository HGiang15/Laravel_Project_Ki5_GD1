...
<div class="container p-5 shadow">
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <h2 class="text-success text-center fst-italic">Department Information</h2>
            <div class="card">
                <div class="card-body">
                    <p><span class="card-title fw-bold">ID department: </span>{{ $department->D_No }}</p>
                    <p><span class="card-title fw-bold">Name department: </span>{{$department->Name}}</p>
                    <p><span class="card-title fw-bold">Location: </span>{{ $department->Location }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mt-5">
            ...
            <a href="{{ route('departments.index') }}" class="btn btn-success">Department List</a>
        </div>
    </div>
