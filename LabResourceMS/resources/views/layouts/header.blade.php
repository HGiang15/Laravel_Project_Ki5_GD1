    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link fs-5" href="{{ route('computerlabs.index') }}"><i class="fa-solid fa-music text-danger mx-1"></i>ComputerLab</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fs-5" href="{{ route('computers.index') }}"><i class="fa-solid fa-user-tie text-success mx-1"></i>Computer</a>
                </li>
